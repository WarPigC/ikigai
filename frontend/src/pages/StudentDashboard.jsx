...
import TrackDetails from "../components/student/TrackDetails";
import SessionChairsList from "../components/student/SessionChairsList";
...
export default function StudentDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-green-100 to-green-200 text-gray-800">
      <StudentHeader student={sessionData?.student} />
      
      <main className="px-6 py-6 space-y-6">
        <div className="bg-white/95 border border-green-100 rounded-2xl p-5 shadow-sm">
          <div className="flex items-start justify-between gap-6">
            <div className="bg-white/95 border border-green-100 rounded-2xl p-5 shadow-sm w-full">
              {/* 1 : 1 Split Container */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                
                {/* LEFT 50% : Track Details */}
                <TrackDetails 
                ...
                {/* RIGHT 50% : Session Chairs */}
                <SessionChairsList chairs={sessionData?.sessionChairs} />
