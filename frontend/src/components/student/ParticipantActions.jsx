    ...
    <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-6 w-full">
      ...
      <div className="w-full md:w-auto">
        <div className="w-full md:w-[160px] rounded-lg border bg-white px-2 py-2 space-y-1">
          <div className={`text-[11px] font-semibold ${hasProof ? "text-purple-700" : "text-gray-500"}`}>
            {hasProof ? "✔ Proof Uploaded" : "⏳ Proof Pending"}
          </div>

          <button
            onClick={() => onProofUpload(participant)}
            className="w-full px-2 py-1 rounded bg-purple-100 text-purple-700 text-[11px] font-semibold hover:bg-purple-200 transition"
          >
          ...
          {hasProof && (
            <div className="grid grid-cols-2 gap-1">
              <button
                ...
                className="px-1 py-0.5 rounded bg-purple-100 text-purple-700 text-[11px] font-semibold hover:bg-green-200 transition"
              >
                View
              </button>
              <button
                onClick={() => onDownloadProof(proofStatus.url, participant.paperId)}
                className="px-1 py-0.5 rounded bg-pink-50 text-purple-700 text-[11px] font-semibold hover:bg-purple-100 transition"
              >
                Download
              </button>
            </div>
      ...
      <div className="grid grid-cols-3 gap-2 w-full md:w-auto">
        ...
        <button
          ...
          className="px-2 py-1 rounded-md bg-pink-50 text-purple-700 text-xs font-semibold hover:bg-purple-100 transition"
        >
          👁 Preview
        </button>
